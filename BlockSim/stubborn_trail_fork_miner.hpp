//
//  stubborn_trail_fork_miner.hpp
//  BlockSim

#ifndef stubborn_trail_fork_miner_hpp
#define stubborn_trail_fork_miner_hpp
...
class StubbornTrailForkPublishingStyle : public PublishingStrategy {
private:
