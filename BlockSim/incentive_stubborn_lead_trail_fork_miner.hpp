...
#ifndef incentive_stubborn_lead_trail_fork_miner_hpp
#define incentive_stubborn_lead_trail_fork_miner_hpp
...
class IncentiveStubbornLeadTrailForkPublishingStyle : public PublishingStrategy {
public:
    IncentiveStubbornLeadTrailForkPublishingStyle(double incentiveFraction, Value forksToIncentivize);
private:
